...
const GROUPS: { label: string; keys: { key: string; label: string; multiline?: boolean; placeholder?: string }[] }[] = [
  ...
  },
  {
    ...
    keys: [
      ...
      { key: "life_gallery_heading", label: "Life @ ATEC — Gallery Heading" },
      { key: "life_videos_heading", label: "Life @ ATEC — Videos Heading" },
  ...
  },
  {
    ...
    keys: [
      ...
      { key: "social_instagram_visible", label: "Instagram Visible (true/false)", placeholder: "true" },
      { key: "social_facebook_url", label: "Facebook URL", placeholder: "https://facebook.com/yourpage" },
      { key: "social_facebook_visible", label: "Facebook Visible (true/false)", placeholder: "true" },
      { key: "social_youtube_url", label: "YouTube URL", placeholder: "https://youtube.com/@yourchannel" },
      { key: "social_youtube_visible", label: "YouTube Visible (true/false)", placeholder: "true" },
      { key: "social_whatsapp_visible", label: "WhatsApp QR Visible (true/false — uses WhatsApp Number above)", placeholder: "true" },
