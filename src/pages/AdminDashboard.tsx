...
const sections = [
  ...
  { key: "restore", label: "Restore from Backup", icon: RotateCcw, color: "bg-rose-700", custom: true, href: "/admin/restore" },
  { key: "seo", label: "SEO Manager", icon: Search, color: "bg-violet-600", custom: true, href: "/crm/seo" },
